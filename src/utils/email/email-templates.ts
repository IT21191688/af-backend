...
const generateTimetableNotificationEmail = (
  student: any,
  timetable: any,
  timetableEvent: any
) => {
  ...
  <body>
      <div class="container">
          <h1>Timetable Update Notification for ${student.userid.firstname} ${
    student.userid.lastname
          ...
          <ul>
              <li><strong>Date:</strong> ${
                timetableEvent.timetableid.year +
                "/" +
                timetableEvent.timetableid.month +
                "/" +
                timetableEvent.timetableid.week
              }</li>
              <li><strong>Time:</strong> ${timetableEvent.timeid.timeslot}</li>
              <li><strong>Location:</strong> ${
                timetableEvent.locationid.roomnumber +
                " " +
                timetableEvent.locationid.location
              }</li>

               <li><strong>Course Name:</strong> ${
                 timetableEvent.timetableid.courseid.coursename
               }</li>
...
const VerificationCodeEmail = (verificationCode: any) => {
  return `<!DOCTYPE html>
    <html>
    <head>
        <meta charset="UTF-8">
